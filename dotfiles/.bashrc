...
pidof i3 > /dev/null && ( cat ~/.cache/wal/sequences & ) && clear   #||  echo ""
clear


#PATH=$PATH:$HOME/WorkSpace/bins/
PATH=${PATH}:$(find $HOME/WorkSpace/bins/ -maxdepth 1 -mindepth 1 -type d | sed '/\/\\./d' | tr '\n' ':' | sed 's/:$//')

GOPATH="$HOME/WorkSpace/goAPP/"

ss_title General
function ss_transparency(){
    transset -i $(xdotool getactivewindow) .$1
}
